...
object ModEntities {
    ...
    val CHOMUSUKE_ENTITY: EntityType<ChomusukeEntity> =
        Registry.register(
            Registries.ENTITY_TYPE,
            Identifier.of("explosion", "chomusuke"),
            EntityType.Builder.create<ChomusukeEntity>(::ChomusukeEntity, SpawnGroup.CREATURE)
                .dimensions(1f, 1f)
                .build(
